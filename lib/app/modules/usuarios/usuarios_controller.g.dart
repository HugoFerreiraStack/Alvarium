...
final $UsuariosController = BindInject(
...
mixin _$UsuariosController on _UsuariosControllerBase, Store {
  final _$valueAtom = Atom(name: '_UsuariosControllerBase.value');
  ...
  @override
  void increment() {
    final _$actionInfo = _$_UsuariosControllerBaseActionController.startAction(
        name: '_UsuariosControllerBase.increment');
    try {
