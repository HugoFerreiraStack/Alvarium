...
class PedidosPageMisterMoore extends StatefulWidget {
  @override
  _PedidosPageMisterMooreState createState() => _PedidosPageMisterMooreState();
}

class _PedidosPageMisterMooreState extends State<PedidosPageMisterMoore> {
  String idPedido;
  ...
  _deleteData2(docId) {
    FirebaseFirestore.instance
        .collection("PedidosMister Moore - 09")
        .doc(docId)
        .delete();
  }
